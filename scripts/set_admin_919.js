...
async function setAdmin() {
    console.log("Updating user 919 to admin...");
    try {
        // Update the role to 'admin' for id_employe '919'
        const result = await sql`
            UPDATE users 
            SET role = 'admin' 
            WHERE id_employe = '919'
        ...
        if (result.length > 0) {
            ...
            console.log("No user found with id_employe = '919'. They will be admin upon signup.");
        }
